...
Used by the codex-image2 MCP bridge as a fallback when the Codex CLI cannot
invoke native imageGeneration (e.g. when the configured Codex provider routes
...
Standalone CLI:
    ...
    python3 images_api_fallback.py generate \\
        --prompt-file prompt.txt \\
        --out figures/ai_generated/figure.png \\
        --size 1024x1024 --quality high

    python3 images_api_fallback.py endpoint   # print the resolved URL
"""
